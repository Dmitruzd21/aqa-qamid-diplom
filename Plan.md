...
ОР: Кнопка "Отправить" меняет название на "Отправляем запрос в Банк"
...
ОР: Кнопка "Отправить" НЕ меняет название на "Отправляем запрос в Банк"
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле номер карты ввести: dddd vvvv nnnn xxxx - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле номер карты ввести: кккк ррррр нннн оооо - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле номер карты ввести: %%%% ???? ;;;; """" - ввод невозможен
...
ОР: Появление информационного окна с текстом: "Оплата по данной карте невозможна"
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле месяц ввести: sd - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле месяц ввести: ва - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле месяц ввести: %% - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле год ввести: нн - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле год ввести: %$ - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле CVC/CVV ввести: 5678 - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле CVC/CVV ввести: ddd - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле CVC/CVV ввести: ррр - ввод невозможен
...
- Кликнуть кнопку "Купить" - появление формы для введения банковских данных ("Оплата по карте")
- В поле CVC/CVV ввести: #@% - ввод невозможен
